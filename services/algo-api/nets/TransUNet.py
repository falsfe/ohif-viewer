...
import numpy as np
from nets.transformers import VisionTransformer
...
class DecoderBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, skip_channels):
        ...
        # self.seblock0 = SEBlock(channel=in_channels + skip_channels, r=16)
...
class TransUNet(nn.Module):
    ...
    def __init__(self, num_class=2):
        ...
        self.segmentationHead = SegmentationHead(
            ...
            out_channels=num_class  # NOTE: assumption because using 9 classes
