...
export const basicLayout = {
  ...
  props: {
    ...
    rightPanels: [cornerstone.segmentation, cornerstone.algorithm, cornerstone.lungVolume, cornerstone.noduleSphere, cornerstone.lungCompare, cornerstone.measurements],
